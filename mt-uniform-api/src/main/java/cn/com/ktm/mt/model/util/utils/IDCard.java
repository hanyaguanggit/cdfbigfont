...
public class IDCard {
    ...
    private static Pattern pattern = Pattern.compile("^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])))))|(\\d{2}(([02468][1235679])|([13579][01345789]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\\s(((0?[0-9])|([1-2][0-3]))\\:([0-5]?[0-9])((\\s)|(\\:([0-5]?[0-9])))))?$");
    private static Pattern isNumeric = Pattern.compile("[0-9]*");
    /** 中国公民身份证号码最小长度。 */
    public static final int CHINA_ID_MIN_LENGTH = 15;
    /**未成年年龄*/
    public static final short MINOR_AGE = 18;
        /*********************************** 身份证验证开始 ****************************************/
    /**
     * 身份证号码验证
    ...
    public static Short getAge(String idCard){
        Short  birth= getYearByIdCard(idCard);
        if(birth == null){
            return null;
        }
    ...
    private static boolean isNumeric(String str) {
        ...
        Matcher isNum = isNumeric.matcher(str);
        if (isNum.matches()) {
            return true;
        } else {
            return false;
