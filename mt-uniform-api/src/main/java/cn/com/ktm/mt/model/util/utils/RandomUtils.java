...
public abstract class RandomUtils {
     ...
     *
     * @param length 字符串长度，if(length<=0) {则不限制长度} else if((length>0)&&(length<=8))
     *               {return null}
     ...
     *
     * @param length 字符串长度，if(length<=0) {则不限制长度} else if((length>0)&&(length<=14))
     *               {return null}
     * @return String
     */
     ...
     *
     * @param randomtype <br>
     *                   type=0(RandomSeed.LOWERCASE_TYPE) -- 字符串全部由小写字符组成 <br>
     *                   type=1(RandomSeed.UPPERCASE_TYPE) -- 字符串全部由大写字母组成 <br>
     *                   type=2(RandomSeed.NUMBER_TYPE) -- 字符串全部由数字组成 <br>
     *                   type=3(RandomSeed.LOWERCASEANDUPPERCASE_TYPE) 字符串由大小写字母混合组成
     *                   <br>
     *                   type=4(RandomSeed.LOWERCASEANDNUMBER_TYPE) 字符串由小写字母和数字混合组成
     *                   <br>
     *                   type=5(RandomSeed.UPPERCASEANDNUMBER_TYPE) 字符串由大写字母和数字混合组成
     *                   <br>
     *                   type=6(RandomSeed.ALL_TYPE) -- 字符串由大小写字母和数字混合组成 <br>
     *                   type=7(RandomSeed.OTHER_TYPE) -- 字符串由大小写字母和数字和特殊字符混合组成 <br>
     *                   type=8(RandomSeed.HEX_TYPE) -- 字符串全部由16位数组成
     * @return String
     */
