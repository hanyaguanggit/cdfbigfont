 ...
 */
@RequiredArgsConstructor(access = AccessLevel.PRIVATE)// 会生成一个包含常量，和标识了NotNull的变量的构造方法。生成的构造方法是私有的private。
@Getter
@EqualsAndHashCode
public class ServiceURI {
    ...
    public static void main(String[] args) {
        System.out.println(JSON.toJSON(create("http://www.baidu.com")) );
    }
}
